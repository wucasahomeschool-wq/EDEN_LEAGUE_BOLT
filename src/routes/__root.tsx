...
import { installAiFallbackWatcher } from "../lib/ai-status";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eden League Simulation App v3" },
      { name: "description", content: "Simulation App for all Eden League purposes" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Eden League Simulation App v3" },
      { property: "og:description", content: "Simulation App for all Eden League purposes" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Eden League Simulation App v3" },
